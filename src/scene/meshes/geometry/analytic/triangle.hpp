...
namespace RT_CPU
{
	...
	{
	public:
		// Refactor class to admit subdivition and ubdate aabb with diplacement map
		Triangle(Vec3f& p_v0, Vec3f& p_v1, Vec3f& p_v2, Vec3f& p_n0, Vec3f& p_n1, Vec3f& p_n2) : Mesh() {
	...
	private:
		// refactor to auto compute subdivition depend of distance (micro triangle)
