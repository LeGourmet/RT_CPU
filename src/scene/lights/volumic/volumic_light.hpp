...
namespace RT_CPU
{
	...
	{
	public:
		VolumicLight(const Vec3f& p_position, const Vec3f& p_direction, const Vec3f& p_color, float p_power, float p_volume, int p_nbShadowRay)
			: Light(p_position, p_direction, p_color, p_power, p_nbShadowRay*p_nbShadowRay*p_nbShadowRay), _volume(p_volume) {}
